...
"""
AppController (UI desarrollador)
--------------------------------
- Coordina eventos de la UI de depuración (clics, botones) y los traduce a acciones
...
from developer_ui.handlers import handle_action
    ...
    def handle_mouse_click(self, event, x, y, flags, app):
        ...
        if event == cv2.EVENT_LBUTTONDOWN:
            try:
                ...
                from developer_ui.panel import detectar_clic_panel_control
