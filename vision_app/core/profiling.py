"""
Profiling helpers (utilidades de profiling)
--------------------------------------------
- Utilidades de profiling para medir rendimiento de bloques específicos durante desarrollo.
- Funcionalidades principales:
  * `PerformanceProfiler`: clase para profiling detallado:
    - `start()`: inicia medición de una operación
    - `mark()`: marca punto intermedio y calcula tiempo desde último mark
    - `end()`: finaliza medición de operación actual
    - `get_report()`: genera reporte con tiempos promedio, máximo, mínimo y porcentajes
    - `reset()`: limpia todas las mediciones
- Útil para desarrollo y optimización de código.
- Nota: Actualmente no se usa en producción, disponible para debugging/desarrollo.
"""
